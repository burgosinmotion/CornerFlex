...
(function validateRectangleLayerScale2DAnimated() {
	...
	var REPORT_NAME = "Phase512BValidationReport.txt";
	var FRAMES_FOLDER_NAME = "Phase512BValidationFrames";
	var MATCH = {
	...
	var TIMES = [0, 0.5, 1];
	var CASES = [
		{id:"A",name:"Base",scaleMode:"static",scale0:[100,100],sampleTimes:[1],trim:10},
		{id:"B",name:"Scale 150x150",scaleMode:"static",scale0:[150,150],sampleTimes:[1],trim:10},
		{id:"C",name:"Scale 150x75",scaleMode:"static",scale0:[150,75],sampleTimes:[1],trim:10},
		{id:"D",name:"Anchor plus Scale",scaleMode:"static",scale0:[150,150],anchor:[100,50],sampleTimes:[1],trim:10},
		{id:"E",name:"Layer Position plus Scale",scaleMode:"static",scale0:[150,150],positionOffset:[240,160],sampleTimes:[1],trim:10},
		{id:"F",name:"Rectangle Position plus Scale",scaleMode:"static",scale0:[150,150],rectPosition:[200,100],sampleTimes:[1],trim:10},
		{id:"G",name:"Animated Scale",scaleMode:"keyframes",scale0:[100,100],scale1:[150,150],sampleTimes:TIMES,trim:10},
		{id:"H",name:"Expression Scale",scaleMode:"expression",expression:"[100 + time * 50, 100 + time * 50]",sampleTimes:TIMES,trim:10},
		{id:"I",name:"Rotation 20 fallback",scaleMode:"static",scale0:[100,100],rotation:20,sampleTimes:[1],trim:10,alwaysFallback:true},
		{id:"J",name:"Rotation 20 plus Scale 150x150 fallback",scaleMode:"static",scale0:[150,150],rotation:20,sampleTimes:[1],trim:10,alwaysFallback:true},
		{id:"K",name:"Return to Layer Bounds",scaleMode:"static",scale0:[150,150],sampleTimes:[1],trim:10}
	]
	var report = [];
	var temporaryComps = [];
	...
	var caseIndex;
	var reportFile;
	appendLine("CornerFlex Phase 5.12B Oriented Rectangle Foundation Visual Validation");
